...
<!-- START: Main Content -->
<!-- jumbotron -->
<div class="jumbotron banner-maroon">
    <div class="container">
            <h1 class="text-white">
              <?php include('rosters/team-names.php'); echo $teamMaroonFirst; ?>
              <br />
              <?php include('rosters/team-names.php'); echo $teamMaroonLast; ?>
            </h1>
    </div>
</div><!-- ./jumbotron -->
<div class="container-fluid">
    <div class="container">
        ...
        <div class="col-sm-6 roster bg-grey mc">
            ...
            <div class="col-sm-12 team-roster"><?php require_once('rosters/roster-maroon.php'); ?></div>
        </div>
